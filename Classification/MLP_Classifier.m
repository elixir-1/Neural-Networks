...
disp('Plotting RMS Error against Number of epochs');
figure(1);
...
Geometric_Accuracy = nthroot(prod(stor(:)), out)




% Test the network.........................................................
NFeature=xlsread('BERK_test_s60');
[NTD,~]=size(NFeature);
...
disp(conftra)
fileID = fopen('BERK_ouput.txt','w');
fprintf(fileID,'%f\n',res_tes);
fclose(fileID);
%xlswrite('BERK_MLP_Classifier_mls_epo',res_tes);
qii = 0;
